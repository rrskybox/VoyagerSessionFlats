...
namespace SessionFlats
{
    public class LogEvent
    {
        ...
        public void LogIt(string logline)
        {
            ...
            string logdirpath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\Documents\\AdvancedVoyager\\SessionsFlats\\Logs";
            ...
            LogEntry(logline);
            FormVoyagerSessionFlats.StatusReportEvent.LogEntry(logline);
        ...
        public void CreateLog()
        {
            ...
            string logdirpath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\Voyager\\SessionsFlats\\Logs";
            if (!Directory.Exists(logdirpath))
            { Directory.CreateDirectory(logdirpath); }
            return;
        }
